...
(let ((colors '(;; Upstream theme color
                ...
                (dracula-comment "#7489cf" "#7a7ac2" "blue")        ; official comment
      ...
      (faces '(;; default / basic faces
               ...
               (font-lock-comment-face :foreground ,dracula-comment :inherit shadow)
;;               (font-lock-comment-face :inherit shadow)
               (font-lock-comment-delimiter-face :foreground ,dracula-comment :inherit shadow)
